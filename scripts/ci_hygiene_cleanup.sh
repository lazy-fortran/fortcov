...
BEFORE_COUNT=$(find . -maxdepth 1 \( -name "test_infra_*.txt" -o -name "test_infra_*.tmp" -o -name "*.gcov" -o -name "*.log" \) 2>/dev/null | wc -l)
...
AFTER_COUNT=$(find . -maxdepth 1 \( -name "test_infra_*.txt" -o -name "test_infra_*.tmp" -o -name "*.gcov" -o -name "*.log" \) 2>/dev/null | wc -l)
...
REMAINING_ARTIFACTS=$(find . -maxdepth 1 \( -name "test_infra_*" -o -name "*_test_*.log" \) 2>/dev/null)
