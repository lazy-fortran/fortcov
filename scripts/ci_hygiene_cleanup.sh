...
REMAINING_ARTIFACTS=$(find . -maxdepth 1 \( -name "test_infra_*" -o -name "*_test_*.log" -o -name "*workspace*" -o -name "auto_discovery_*" -o -name "gcov_executor_test*" -o -name "test_*" \) 2>/dev/null)
