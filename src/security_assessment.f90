module security_assessment
    ...
    use security_pattern_analyzer, only: pattern_cache_t, CACHE_SIZE, &
                                          analyze_pattern_risks, &
                                          find_cached_pattern, &
                                          cache_pattern_results
    use security_disk_assessment, only: get_disk_space_risk, &
                                        assess_disk_risk_for_file
    use security_file_location, only: check_file_location, &
