module coverage_file_types
    !! File Coverage Type Module
    !!
    !! Provides types and operations for file-level coverage tracking.
    ...
    ! file_coverage_t and line_coverage_t are already in coverage_location_types
    ...
    ! file_coverage_t and line_coverage_t are imported from coverage_location_types
