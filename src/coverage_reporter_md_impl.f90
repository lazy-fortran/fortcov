module coverage_reporter_md_impl
    ...
    use markdown_reporter_impl, only: generate_markdown_report, markdown_report_options_t
...
end module coverage_reporter_md_impl