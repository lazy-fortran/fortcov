module coverage_data_types
    !! Coverage Data Container Types Module
    !!
    !! Contains overall coverage data container types and procedures:
    !! - coverage_data_t: Overall coverage data container with aggregation
    !! - Associated procedures for overall coverage calculation and serialization
    !!
