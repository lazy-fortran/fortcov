module atomic_temp_file_c_interface
    !! C interface declarations for atomic temporary file operations
    !! 
    !! This module provides the C binding interfaces for secure temporary
    !! file operations on Unix/Linux and Windows platforms.
    ...
    public :: c_malloc, c_free, is_unix_platform
    public :: get_secure_temp_file_state_size
    ...
    interface
        ...
        ! Security feature checking interfaces - Unix
        function temp_file_used_exclusive_creation_unix(state) &
            bind(c, name='temp_file_used_exclusive_creation_unix') result(used)
            import :: c_ptr, c_int
            type(c_ptr), value :: state
            integer(c_int) :: used
        ...
        function temp_file_prevents_symlink_following_unix(state) &
            bind(c, name='temp_file_prevents_symlink_following_unix') result(prevents)
            import :: c_ptr, c_int
            type(c_ptr), value :: state
        ...
        function temp_file_uses_unix_security_features_unix(state) &
            bind(c, name='temp_file_uses_unix_security_features_unix') result(uses)
            import :: c_ptr, c_int
            type(c_ptr), value :: state
            integer(c_int) :: uses
        end function temp_file_uses_unix_security_features_unix
        
        ! Baseline creation for testing - Unix
        ...
        ! State extraction interfaces - Unix
        ...
        function get_entropy_bits_from_state_unix(state) &
            bind(c, name='get_entropy_bits_from_state_unix') result(entropy_bits)
            import :: c_ptr, c_int
            type(c_ptr), value :: state
            integer(c_int) :: entropy_bits
        ...
        function write_atomic_temp_file_windows(state, data, data_len, &
            error_code) bind(c, name='write_atomic_temp_file_windows') result(status)
            import :: c_ptr, c_char, c_size_t, c_int
            type(c_ptr), value :: state
            character(c_char), intent(in) :: data(*)
            integer(c_size_t), value :: data_len
        ...
        function move_atomic_temp_file_windows(state, target_path, &
            error_code) bind(c, name='move_atomic_temp_file_windows') result(status)
            import :: c_ptr, c_char, c_int
            type(c_ptr), value :: state
            character(c_char), intent(in) :: target_path(*)
            integer(c_int), intent(out) :: error_code
        ...
        ! Security feature checking interfaces - Windows
        function temp_file_used_exclusive_creation_windows(state) &
            bind(c, name='temp_file_used_exclusive_creation_windows') result(used)
            import :: c_ptr, c_int
            type(c_ptr), value :: state
            integer(c_int) :: used
        ...
        function temp_file_get_creation_time_gap_windows(state) &
            bind(c, name='temp_file_get_creation_time_gap_windows') result(gap)
            import :: c_ptr, c_double
            type(c_ptr), value :: state
            real(c_double) :: gap
        ...
        function temp_file_prevents_symlink_following_windows(state) &
            bind(c, name='temp_file_prevents_symlink_following_windows') result(prevents)
            import :: c_ptr, c_int
            type(c_ptr), value :: state
            integer(c_int) :: prevents
        ...
        function temp_file_uses_windows_security_features_windows(state) &
            bind(c, name='temp_file_uses_windows_security_features_windows') result(uses)
            import :: c_ptr, c_int
            type(c_ptr), value :: state
            integer(c_int) :: uses
        end function temp_file_uses_windows_security_features_windows
        
        ! Baseline creation for testing - Windows
        ...
        ! State extraction interfaces - Windows
        ...
        function get_entropy_bits_from_state_windows(state) &
            bind(c, name='get_entropy_bits_from_state_windows') result(entropy_bits)
            import :: c_ptr, c_int
            type(c_ptr), value :: state
            integer(c_int) :: entropy_bits
        end function get_entropy_bits_from_state_windows
        
        ! Standard C library interfaces for memory management
...
end module atomic_temp_file_c_interface