module config_parser_command_line
    !! Command-line parsing for configuration management
    !!
    !! This module handles the main command-line parsing logic, including
    !! zero-configuration mode detection, positional argument processing,
    !! and fork bomb prevention.
