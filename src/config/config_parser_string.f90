module config_parser_string
    !! String parsing utilities for configuration values
    !!
    !! Provides type conversion utilities with comprehensive error handling
    !! for real numbers, integers, and threshold values.
...
end module config_parser_string