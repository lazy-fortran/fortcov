module json_tokenizer_impl
    ...
    public :: parse_string_token
    public :: parse_number_token
    public :: parse_literal_token
    public :: add_token
    public :: unescape_json_string
    public :: is_whitespace, is_digit, is_alpha
...
end module json_tokenizer_impl