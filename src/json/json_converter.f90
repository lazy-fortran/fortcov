module json_converter
    !! JSON Conversion Utilities Module
    !!
    !! Handles conversion utilities:
    !! - JSON to XML conversion for coverage reports
    !! - Value extraction from JSON strings
