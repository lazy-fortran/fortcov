module json_validator
    !! JSON Validator - Consolidated validation and schema checking
    !!
    !! Consolidated from json_validator_impl.f90 while preserving all functionality.
    !! This consolidation eliminates the unnecessary _impl pattern while maintaining
    !! clear separation of validation concerns from core JSON processing.
    use constants_core
    use json_core
