...
echo ""
echo "File output options:"
echo "  --output-format=html     - Generate HTML coverage report"
echo "  --output-format=markdown - Generate Markdown coverage report"
echo "  --output-format=json     - Generate JSON coverage report"
echo "  --output-format=xml      - Generate XML coverage report"
echo "  --output-path=coverage.html - Specify output file path"